...
<div id="nav1"><div id="nav"><?php if (Content::countModules('nav') > 0 || Toolkit::editMode()) Content::loadModules('nav'); ?></div></div>
...
<div class="top_back"><img src="/images/back_top.png" border="0" /></div>
...
<div id="left"><?php include_once($_content_); ?></div>
<?php 
//--------------内页样式【end】----------------------
}?>
...
<div class="top_back"><img src="/images/back_top2.png" border="0" /></div>
</div>
<div id="footermain">
<?php 
//加载页面尾部
