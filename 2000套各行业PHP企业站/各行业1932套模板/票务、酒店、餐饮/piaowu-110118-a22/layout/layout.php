...
<div class="langbar_out">
<!-- Õ¾µãÓïÑÔÄ£¿éStart -->
<div class="switch_langbar" style="float:right;margin-top:20px; margin-right:15px; height:20px;"><?php include_once(P_INC.'/language_switch.php');?></div>
<!-- Õ¾µãÓïÑÔÄ£¿éEnd -->
</div>

<div id="nav"><?php if (Content::countModules('nav') > 0 || Toolkit::editMode()) Content::loadModules('nav'); ?></div>
            </div>
     </div>  
