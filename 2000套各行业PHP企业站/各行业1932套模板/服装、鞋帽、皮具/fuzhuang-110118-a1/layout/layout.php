...
<!-- վ������ģ��End -->
		...
		<div id="main_top"><img src="<?php echo P_TPL_WEB; ?>/images/cloth_03.png" width="1001" height="12" /></div>
        <?php 
		//--------------首页样式【start�?------------------
...
?>
	<div id="bot"><img src="<?php echo P_TPL_WEB; ?>/images/bot.png" width="1001" height="30" /></div>
