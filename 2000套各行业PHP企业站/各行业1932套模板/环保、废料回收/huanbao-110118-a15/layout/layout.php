...
<div id="mainmain">
   ...
   <div id="banner">
	<?php 
		...
		?>
        <div id="user1"><?php if (Content::countModules('user1') > 0 || Toolkit::editMode()) Content::loadModules('user1'); ?>
        <a href="index.php?_m=mod_product&_a=prdlist"><img src="/admin/fckeditor/upload/../../../upload/image/all_pic.jpg" height="241" width="960" /></a>
        </div>
          <div id="left">
