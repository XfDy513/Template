...
<!-- 站点语言模块End -->
		...
		<div id="top_link"><?php if(EZSITE_LEVEL=='2'){?><?php }?></div>
...
<div class="web_bg">
	...
	<?php 
     ...
     <div id="zmd">
	<?php if (Content::countModules('zmd') > 0 || Toolkit::editMode()) Content::loadModules('zmd'); ?>
	</div>  
	<div id="main_con">
    <?php 
		//--------------首页样式【start】-------------------
...
<div id="left">
    ...
    <div id="hotpro">
	<?php if (Content::countModules('hotpro') > 0 || Toolkit::editMode()) Content::loadModules('hotpro'); ?>
	</div>  
    </div>
    </div>
<?php 
