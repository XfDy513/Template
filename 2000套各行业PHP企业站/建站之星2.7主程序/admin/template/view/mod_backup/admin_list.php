	...
	<tbody>
		...
		?>
				<tr>
					...
					<td><?php echo date( 'Y-m-d H:i', $value[0]['ftime'] );?></td>
					<td>
						<a href="#" onclick="import_backup('<?php echo $value[0]['fname'];?>');return false;" title="<?php _e('Import'); ?>"><img src="<?php echo P_TPL_WEB;?>/images/import.gif" style="border:none;cursor:pointer" title="<?php _e('Import');?>"></a>&nbsp;&nbsp;
						<a href="<?php echo Html::uriquery('mod_backup', 'admin_load',array('_fid'=>"$v_name")); ?>"><img style="border:none;" title="<?php _e('Click to download a database backup file');?>" src="<?php echo P_TPL_WEB;?>/images/download.gif"></a>&nbsp;&nbsp;
